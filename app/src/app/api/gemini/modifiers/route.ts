...
## 예시
키워드: "노트북 추천" → ["가성비", "게임", "게이밍", "메이플", "던파", "로스트아크", "발로란트", "배그", "사무용", "영상편집", "코딩", "포토샵", "프리미어", "삼성", "LG", "레노버", "ASUS", "대학생", "직장인", "2025", "가벼운", "고성능", "15인치", "터치"]
키워드: "피자" → ["배달", "냉동", "도미노", "피자헛", "파파존스", "미스터피자", "1인", "맛있는", "강남", "파티", "오븐", "치즈", "페퍼로니", "고구마"]
...
9. **★ 구체적 고유명사 (가장 중요!)**: 해당 제품과 함께 사용하는 **구체적인 게임명, 소프트웨어명, 앱명, 자격증명, 프로그램명, 서비스명** 등 실제 이름. 예: 노트북이면 메이플, 던파, 로아, 로스트아크, 발로란트, 배그, 오버워치, 리그오브레전드, 롤, 스타크래프트, 디아블로, 마인크래프트, 원신, 블루아카이브, GTA, 피파, FC온라인, 서든어택, 리니지, 검은사막, 포토샵, 프리미어, 일러스트, 오토캐드, 한글, 엑셀, VS코드 등. **이 차원이 가장 중요합니다. 최소 50개 이상 생성하세요.**
10. **평가/수식**: 인기, 베스트, 추천, 유명한, 좋은 등 평가성 표현

## 주의사항
- 해당 키워드 분야에 맞지 않는 차원은 건너뛰어도 됩니다
- 1~8번, 10번 차원에서 각 10~20개씩, 9번 차원에서 150개 이상, **총 300개 이상** 생성하세요
- 1~3글자 짧은 수식어를 우선하세요 (검색 자동완성에 효과적)
- 같은 의미라도 검색 형태가 다르면 둘 다 포함하세요 (예: "게임", "게이밍" / "학생", "대학생")
- **9번 차원(구체적 고유명사)이 전체의 절반 이상이어야 합니다**. 사람들은 "메이플 노트북", "포토샵 노트북"처럼 구체적인 이름으로 검색합니다. 해당 분야에서 떠올릴 수 있는 모든 게임, 소프트웨어, 앱, 서비스 이름을 빠짐없이 나열하세요

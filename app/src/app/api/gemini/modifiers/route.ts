...
9. **★ 구체적 고유명사**: 해당 제품으로 사용하는 **구체적인 게임명, 소프트웨어명, 앱명, 자격증명, 프로그램명** 등 (예: 노트북이면 메이플스토리, 던파, 로스트아크, 발로란트, 포토샵, 한글, 엑셀 등 실제 이름). **이 차원이 가장 중요합니다. 최소 15개 이상 생성하세요.**
10. **평가/수식**: 인기, 베스트, 추천, 유명한, 좋은 등 평가성 표현

## 주의사항
- 해당 키워드 분야에 맞지 않는 차원은 건너뛰어도 됩니다
- 각 차원에서 최소 3~8개씩, **총 80개 이상** 생성하세요
- 1~3글자 짧은 수식어를 우선하세요 (검색 자동완성에 효과적)
- 같은 의미라도 검색 형태가 다르면 둘 다 포함하세요 (예: "게임", "게이밍" / "학생", "대학생")
- **9번 차원(구체적 고유명사)을 특히 많이 생성하세요**. 사람들은 "메이플 노트북", "포토샵 노트북"처럼 구체적인 이름으로 검색합니다
